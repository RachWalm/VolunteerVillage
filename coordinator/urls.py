...
urlpatterns = [
    ...
    path("coordinator/activate_volunteer/<id>", views.activate_volunteer, name="activatevol"),
    path("coordinator/activate_volunteers", views.activate_volunteers, name="activatevols"),
]